    ...
    <div name="home" class=" top-0 left-0 max-w-[1200px] w-full max-h-[100%] sm:flex sm:flex-row justify-center items-center mx-auto gap-5 ">
      <div class="w-full h-screen md:max-w-[750px] text-left">
        <div class="max-w-[1000px] flex flex-col justify-center h-full mx-8 sm:ml-8">
          ...
          <h1 class="text-4xl md:text-7xl font-bold text-[#3c75b1] mb-2">Swapnil Salsankar</h1>
          <h6 class="text-2xl md:text-3xl font-bold text-[#6c7fa1] max-w-[800px]"><TypeAnimation
              ...
              repeat={Infinity}
              /></h6>
          <p class="text-[#d0d2d6] py-4 max-w-[700px]">With a relentless passion for innovation, I specialize in architecturing robust infrastructures and streamlining deployment pipelines to ensure the seamless delivery of applications in cloud environments. 
         ...
         Explore my portfolio to discover how I combine my skills in DevOps and cloud technologies to create efficient and scalable solutions.</p>
          <div className='flex flex-row gap-4'>
              <a className='rounded-lg shadow-lg shadow-[#abb0b6] text-gray-300 bg-blue-600  m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300' 
                        href="https://www.linkedin.com/in/swapnil-salsankar/">
                    ...
                    href="https://github.com/swapnilsalsankar">
                    ...
                    href="mailto: salsankar.s@northeastern.edu">
