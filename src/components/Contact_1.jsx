      ...
      <div class="shadow-md shadow-[#b1b8c1] bg-white group container rounded-md  flex flex-col p-6">
            <div class="flex">
                ...
                <div class="flex-initial w-48 text-left">
                    ...
                    <a href="https://www.linkedin.com/in/swapnil-salsankar/" className='w-[25%] flex justify-center items-center rounded-full shadow-lg bg-blue-500 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <BsLinkedin size={20} />
                    </a>
                    <a href="https://github.com/swapnilsalsankar" className='w-[25%] flex justify-center items-center rounded-full shadow-lg bg-black m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <BsGithub size={20} />
                    </a>
                    <a href="https://wa.me/+1617238473" className='w-[25%] flex justify-center items-center rounded-full shadow-lg bg-green-500 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <BsWhatsapp size={20} />
                    </a>
                    </div>
      ...
      <div class="shadow-md shadow-[#b1b8c1] bg-white group container rounded-md  flex flex-col p-6">
            <div class="flex">
                ...
                <div class="flex-initial w-48 text-left">
                        ...
                        <a className='text-black cursor-pointer' href="mailto: patidar.as@northeastern.edu">salsankar.s@northeastern.edu</a>
                        {/* <p>
      ...
      <div class="shadow-md shadow-[#b1b8c1] bg-white group container rounded-md  flex flex-col p-6">
            <div class="flex">
                ...
                <div class="flex-initial w-48 text-left">
                        ...
                        <p className='text-black'>+1(617) 238-4773</p>
